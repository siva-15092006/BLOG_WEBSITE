...
export function forgotPwd(formValues) {
  const request = axios.post(`${ROOT_URL}/users/forgotpwd`, formValues);
  return {
    type: FORGOT_PWD,
    payload: request
  };
...
export function forgotPwdSuccess(data) {
  return {
...
export function forgotPwdFailure(error) {
  return {
